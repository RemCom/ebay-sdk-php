...
class GetProductSearchNamesResponseTest extends TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\ProductMetadata\Types\GetProductSearchNamesResponse', $this->obj);
    }
